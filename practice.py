...
class Triangle(Shape):
    ...
    def measure(self):
        a = math.sqrt(math.fabs(self.p1[0] - self.p2[0]) ** 2 + math.fabs(self.p1[1] - self.p2[1]) ** 2)
        b = math.sqrt(math.fabs(self.p2[0] - self.p3[0]) ** 2 + math.fabs(self.p2[1] - self.p3[1]) ** 2)
        c = math.sqrt(math.fabs(self.p3[0] - self.p1[0]) ** 2 + math.fabs(self.p3[1] - self.p1[1]) ** 2)
        s = (a + b + c) / 2
