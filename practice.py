...
class Triangle(Shape):
    ...
    def measure(self):
        ...
        b = math.sqrt((self.p2[0] - self.p3[0]) ** 2 + (self.p2[1] - self.p3[1]) ** 2)

        c = math.sqrt((self.p1[0] - self.p3[0]) ** 2 + (self.p1[1] - self.p3[1]) ** 2)
