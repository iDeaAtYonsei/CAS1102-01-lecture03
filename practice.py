...
class Triangle(Shape):
    ...
    def measure(self):
        d1 = math.sqrt((self.p1[0] - self.p2[0])**2 + (self.p1[1] - self.p2[1])**2)
        d2 = math.sqrt((self.p2[0] - self.p3[0])**2 + (self.p2[1] - self.p3[1])**2)
        d3 = math.sqrt((self.p1[0] - self.p3[0])**2 + (self.p1[1] - self.p3[1])**2)
        s = (d1 + d2 + d3) / 2
