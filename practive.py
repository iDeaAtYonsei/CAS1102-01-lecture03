...
class Triangle(Shape):
    ...
    def measure(self):
        import math
        a = math.sqrt((self.__p2[0] - self.__p1[0]) ** 2 + (self.__p2[1] - self.__p1[1]) ** 2)
        b = math.sqrt((self.__p3[0] - self.__p2[0]) ** 2 + (self.__p3[1] - self.__p2[1]) ** 2)
        c = math.sqrt((self.__p1[0] - self.__p3[0]) ** 2 + (self.__p1[1] - self.__p3[1]) ** 2)
        s = (a + b + c) / 2
